    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className="navbar--logo">
          <img src="./img/portfolio logo.png" alt="Logoipsum" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/syed.fraz.35728/"
            ...
            <li>
              <a
                href="https://www.instagram.com/syedfraz_18/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.threads.net/@syedfraz_18"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/syed-fraz-mar2003/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
